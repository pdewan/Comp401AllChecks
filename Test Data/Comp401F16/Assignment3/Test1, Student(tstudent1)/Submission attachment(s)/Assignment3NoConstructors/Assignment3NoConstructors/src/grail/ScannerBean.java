	...
	private static void scanString(String s){
		...
		while (iterator.hasNext()){
			...
			if (Character.isDigit(tokenString.charAt(0))){
				...
				if (valid){
					tokenObject = new NumberToken();
					tokenObject.setInput(tokenString);
