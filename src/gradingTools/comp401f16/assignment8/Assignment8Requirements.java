package gradingTools.comp401f16.assignment8;

import grader.basics.execution.GradingMode;
import grader.junit.AJUnitProjectRequirements;
import gradingTools.comp401f16.assignment1.testcases.ImageEnclosedTestCase;
import gradingTools.comp401f16.assignment8.testcases.Assignment8Suite;
...
public class Assignment8Requirements  extends AJUnitProjectRequirements{
	public Assignment8Requirements(){
		addDueDate("10/27/2016 00:59:00", 1.05); 	// wed before
     	addDueDate("10/29/2016 00:59:00", 1); 		// fri due
     	addDueDate("11/01/2016 00:59:00", 0.95);	// mon after due
     	addDueDate("11/05/2016 00:59:00", 0.90); 	// fri after due
