...
public class Assignment1Requirements extends AJUnitProjectRequirements {
	public Assignment1Requirements() {
		...
		addDueDate("05/28/2024 01:00:00", 1.05);
		addDueDate("05/29/2024 01:00:00", 1.0);
		addDueDate("06/02/2024 01:00:00", 0.9);
		addDueDate("06/03/2024 01:00:00", 0.8);
		addDueDate("06/25/2024 01:00:00", 0.5);
		
		addJUnitTestSuite(SS24Assignment1Suite.class);
